 ...
 function shouldUseSportsQuery(text: string) {
  ...
  function hasRecentSportsContext(currentText: string) {
    ...
    const followUpPatterns = [
      ...
      // STEP 14 — natural live-game companion follow-ups
      ...
      /^what is going on\b/,
      /^where are we at\b/,
      /^what's the situation\b/,
      /^whats the situation\b/,

      // Baseball natural follow-ups
      /^who's pitching\b/,
      /^whos pitching\b/,
      /^who is pitching\b/,
      /^who's batting\b/,
      ...
      // Football natural follow-ups
      /^who has possession\b/,
      /^what down\b/,
      /^down and distance\b/,
      /^how many yards\b/,

      // Basketball / hockey / soccer follow-ups
      /^who's leading\b/,
      /^whos leading\b/,
      /^who is leading\b/,
      /^who scored\b/,
